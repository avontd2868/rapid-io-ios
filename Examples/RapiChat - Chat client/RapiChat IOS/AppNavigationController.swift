...
private extension AppNavigationController {
    ...
    func setupUI() {
        ...
        navigationBar.backIndicatorImage = UIImage(named: "Btn-Navigation-Back")?.resizableImage(withCapInsets: UIEdgeInsets.zero)
        navigationBar.backIndicatorTransitionMaskImage = UIImage(named: "Btn-Navigation-Back")?.resizableImage(withCapInsets: UIEdgeInsets.zero)
